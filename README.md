...
Built on [RecompOne](https://github.com/BlackLabelHQ/RecompOne) (static PS1 recompilation + runtime). Current release: **1.4.0** (native WinForms launcher on Windows; CLI on Linux). Still experimental — expect bugs.
