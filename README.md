...
Built on [RecompOne](https://github.com/BlackLabelHQ/RecompOne) (static PS1 recompilation + runtime). Current release: **1.2.0** (16:9 widescreen + cheat menu). Still experimental — expect bugs.
