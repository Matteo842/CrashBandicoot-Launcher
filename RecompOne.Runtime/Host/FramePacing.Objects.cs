...
public static partial class FramePacing
{
    ...
    static bool IsPlanC(IMemory m, uint obj)
    {
        try
        {
            return TryReadGoolClass(m, obj, out uint type, out _) && type == GoolTypePlan;
        }
        catch
        {
            return false;
    ...
    static bool IsFatsC(IMemory m, uint obj)
    {
        try
        {
            return TryReadGoolClass(m, obj, out uint type, out _) && type == GoolTypeFats;
        }
        catch
        {
            return false;
